...
module "keypair" {
  source = "git@github.com:slovink/terraform-aws-keypair.git?ref=v1.0.0"

  name        = "${local.name}-key"
  environment = local.environment
  public_key  = ""
  #  create_private_key_enabled = null
...
module "ssh" {
  source = "git@github.com:slovink/terraform-aws-security-group.git?ref=v1.0.0"
...
module "iam-role" {
  source = "git@github.com:slovink/terraform-aws-iam-role.git?ref=v1.0.0"
